<%@ Page ValidateRequest="false" Title="新增" Language="C#" MasterPageFile="~/Sys/MasterPage.master"
    AutoEventWireup="true" CodeFile="News_Insert.aspx.cs" Inherits="manage_News_News_Insert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="from_table">
        <tr style="display: inherit">
            ...
            <td>
                <asp:TextBox ID="title" runat="server" Width="500px" CssClass="{validate:{required:true, messages:{required:'標題必填'}}}"></asp:TextBox>
            </td>
        </tr>
        
        <tr style="display: inherit">
            <th>
                <asp:Label ID="lblpicUrl" runat="server" AssociatedControlID="fuPic">圖片</asp:Label>
            </th>
            <td>
        ...
        <tr style="display: inherit">
            <th>
                <asp:Label ID="lblstartDate" runat="server" AssociatedControlID="startDate" CssClass="{validate:{required:true, messages:{required:'開始日期必填'}}}">開始日期</asp:Label>
            </th>
            <td  class="datepicker">
                <asp:TextBox ID="startDate" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td  class="datepicker">
                <asp:TextBox ID="endDate" runat="server" Width="250px" CssClass="{validate:{date:true, messages:{date:'結束日期格式不正確'}}}"></asp:TextBox>
                (不設定代表永遠生效)
            </td>
        </tr>
                    <tr style="display: inherit">
    ...
    <asp:Panel ID="pnlHidden" runat="server" Visible="false">
        <table>
            ...
            <tr style="display: inherit">
            <th>
                <asp:Label ID="lblinitDate" runat="server" AssociatedControlID="initDate">張貼時間</asp:Label>
            </th>
            <td  class="datepicker">
                <asp:TextBox ID="initDate" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
        ...
        <tr style="display: inherit">
            ...
            <asp:TextBox ID="fileUrl" runat="server" Width="250px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
        ...
        <tr style="display: inherit">
            ...
            <td>
                <asp:TextBox
                ID="linkText" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="poster" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="posterUnit" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="updater" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="updaterUnit" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                 <asp:TextBox
                ID="lastupdated" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="counts" runat="server" Width="250px" CssClass="{validate:{required:true, number:true, messages:{required:'必填', number:'須為數字'}}}"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
            ...
            <td>
                <asp:TextBox
                ID="listNum" runat="server" Width="250px" CssClass="{validate:{required:true, number:true, messages:{required:'必填', number:'須為數字'}}}"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: inherit">
            <th>
                <asp:Label ID="lblenable" runat="server" AssociatedControlID="enable">顯示狀態</asp:Label>
            </th>
            <td>
        ...
        <tr style="display: inherit">
            ...
            <td>
                <asp:TextBox
                ID="status" runat="server" Width="250px"></asp:TextBox>
            </td>
        </tr>
        </table>
    </asp:Panel>
    <div class="bottom_btn">
        <asp:Button ID="InsertButton" runat="server" Text="加入" CssClass="button" OnClick="InsertButton_Click">
        </asp:Button>
        <input onclick="history.back();" type="button"
            value="回列表" class="button" /></div>
    <div>
