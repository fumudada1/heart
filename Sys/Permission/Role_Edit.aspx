<%@ Page Title="" Language="C#" MasterPageFile="~/Sys/MasterPage.master" AutoEventWireup="true" CodeFile="Role_Edit.aspx.cs" Inherits="manage_A01Permission_Role_Edit" %>
...
<div>
        <legend>編輯</legend>
        <label>
            名稱名稱</label>&nbsp;<asp:TextBox ID="roleName" runat="server" Width="250px"></asp:TextBox> </div> 
       <div> <label>
    ...
    <fieldset>
        ...
        <uc1:PermissionUserControl ID="PermissionUserControl2" runat="server" />
    </fieldset>
    <div class="bottom_btn">
        <asp:Button ID="btnUpdate" runat="server" Text="確定" OnClick="btnADD_Click" 
            CssClass="button" />
