<%@ Page Title="" Language="C#" MasterPageFile="~/Heart.master" AutoEventWireup="true" CodeFile="MemberNews_List.aspx.cs" Inherits="MemberNews_List" %>
...
<asp:HyperLink ID="hlAbout" runat="server" Text='<%# My.WebForm.limitWord(Eval("title"),20)  %>'
                        NavigateUrl='<%# "MemberNews_Detail.aspx?id="+Eval("id") %>'> </asp:HyperLink></p>
