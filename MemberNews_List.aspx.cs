...
public partial class MemberNews_List : System.Web.UI.Page
{
    ...
    private void Show()
    {
        ...
        int totaleItems = dl.GetPublishListCount("N02", "", "", txtSearch.Text,"", DataLayer.SortMethed.OrderByInitDate, true);
        Pagination1.totalitems = totaleItems;
        Pagination1.limit = PageSize;
        Pagination1.targetpage = "MemberNews_List.aspx";
        //技巧:利用這種方式才可以呼叫usercontrol裡的public method
        UserControl_Pagination uc = Pagination1;
        uc.showPageControls();
        DataTable dt = dl.GetPublishList("N02", "", "", txtSearch.Text,"", DataLayer.SortMethed.OrderByInitDate, true, PageSize, Request["page"] == null ? 1 : int.Parse(Request["page"]));
